...
import { LogOut, TrendingUp, Wallet, Settings, ChevronDown } from "lucide-react"
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-2 px-2 md:px-3 py-1.5 md:py-2 rounded-xl bg-gradient-to-br from-gray-50/80 to-gray-100/80 dark:from-slate-800/50 dark:to-slate-900/50 backdrop-blur-sm border border-gray-200/50 dark:border-slate-700/50 shadow-sm transition-all duration-300 hover:shadow-md active:scale-95">
                    <Avatar className="h-7 w-7 md:h-9 md:w-9 ring-2 ring-white/50 dark:ring-slate-700/50">
            ...
            <DropdownMenuContent align="end" className="w-72 p-3 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-gray-200/60 dark:border-slate-800/60 shadow-xl">
                        ...
                        <div className="space-y-2 px-2 py-2">
                            ...
                            <div className="px-3 py-2.5 rounded-lg bg-gradient-to-br from-blue-50/80 to-purple-50/80 dark:from-slate-800/50 dark:to-slate-900/50 border border-gray-200/50 dark:border-slate-700/50">
                                ...
                                <p className="text-lg font-bold text-gray-900 dark:text-white">
                                    {formatCurrency(stats.currentEquity, settings)}
                                </p>
                            </div>
                            ...
                            <div className="px-3 py-2.5 rounded-lg bg-gradient-to-br from-gray-50/80 to-gray-100/80 dark:from-slate-800/50 dark:to-slate-900/50 border border-gray-200/50 dark:border-slate-700/50">
                                ...
                                <div className="flex items-baseline gap-2">
                                    <p className={cn(
                                        ...
                                        {stats.totalPnL >= 0 ? '+' : ''}{formatCurrency(Math.abs(stats.totalPnL), settings)}
                                    </p>
                                    <span className={cn(
                ...
                <DropdownMenuItem asChild>
                    <Link href="/settings" className="px-3 py-2 cursor-pointer text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-lg">
