...
>(({ className, children, onOpenAutoFocus, onCloseAutoFocus, onKeyDown, ...props }, ref) => {
  const contentRef = React.useRef<HTMLDivElement | null>(null);

  const handleOpenAutoFocus = React.useCallback(
    (event: Event) => {
      // Let Radix handle focus for surfaces with focusable elements.
      // For empty surfaces, prevent Radix default and focus the container.
